...
upstream = {
    "get-rates-years": {
        "nb": "/home/lmorales/work/stillbirth-book/pipeline/output/get-rates-years.ipynb",
        "data": "/home/lmorales/work/stillbirth-book/pipeline/output/stillbirths-rates-by-year.parquet",
    }
}
product = {
    "nb": "/home/lmorales/work/stillbirth-book/pipeline/output/plot-rates-years.ipynb",
    "data": "/home/lmorales/work/stillbirth-book/pipeline/output/plot-rates-years.pdf",
}


# + tags=[]
# create a temp folder
TMP_FOLDER_DIR = './plot-rates-years-tmp-data'
...
print(len(df))
df = \
    df[df.departamento_id.isin(departments_idx)]
print(len(df))
...
def plot_tasas_by_departments(
    ...
    while BASE < TOTAL:
        ...
        figure_data = provincial_data\
            [provincial_data.departamento_id.isin(figure_department_idx)]
...
plot_tasas_by_departments(
    data_provincia_i, department_names_dict,
...
# + tags=[]
Image(filename='./plot-rates-years-tmp-data/rates-Tucumán-1.png')
...
'''
report_content += get_fig_template(MAPS_PNG_DIR, 1200, 1200)

# add lineplots:
report_content += '''
    <div style = "display:block; clear:both; page-break-after:always;"></div>
    <h1 align="center">Tasas anuales por departamentos</h2>
'''
