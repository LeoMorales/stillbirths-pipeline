...
def get_stillbirths(product):
    # # Mortinatos
    datos_defunciones_fetales = pandas.read_csv(
        '../datasets/nacidos-vivos-y-muertes-fetales/1994-2019_NUEVO CODIGO Defunciones fetales .xlsx - Defunciones fetales 1995.csv',
